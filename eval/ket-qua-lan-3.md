...
| G03 | thuong | chatlog M1612 | agent la gi | `json_khong_parse_duoc` | ❌ | loi_ky_thuat:json_khong_parse_duoc |
...
| G11 | 1 | tu nghi | Sinh cau hoi kiem tra hieu tu slide nay | `json_khong_parse_duoc` | ❌ | loi_ky_thuat:json_khong_parse_duoc |
